					...
					<div class="d-flex justify-content-between align-items-center">
						...
						<div class="input-group">
							<span class="input-group-text">$</span> <input type="number"
								name="amount" class="form-control" step="0.01" value="0" min="0"
								required />
						</div>
					</div>
					...
					<div class="d-flex justify-content-between align-items-center mb-2">
						...
						<div class="form-floating text-dark">
							<input type="password" class="form-control" id="floatingPassword"
								placeholder="Password" name="password" minlength="3"
								maxlength="3" required> <label for="floatingPassword">CVC</label>
						</div>
					</div>
