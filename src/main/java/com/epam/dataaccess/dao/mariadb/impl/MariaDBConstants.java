...
public final class MariaDBConstants {
	...
	public static final String TARIFF_PRICE_FIELD = "tariff.price";
	...
	public static final String GET_ALL_SUBSCRIBERS = new QueryStringBuilder()
			.addSelect(USER_ID_FIELD + ", " + USER_PASSWORD_FIELD + ", " + USER_SALT_FIELD + ", " + USER_LOGIN_FIELD
					...
					+ USER_FIRST_NAME_FIELD + ", " + USER_LAST_NAME_FIELD + ", " + USER_CITY_FIELD + ", "
					+ USER_ADDRESS_FIELD + ", " + USER_BALANCE_FIELD)
			.addFrom(USER_TABLE).addWhere(USER_ROLE_ID_FIELD + " = ?")
			.getQuery();
	...
	public static final String GET_SUBSCRIBER_COUNT =  new QueryStringBuilder().addSelect("").addCount("*")
			...
			.addLike().getQuery();
	public static final String CHANGE_USER_PASSWORD = new QueryStringBuilder().addUpdate(USER_TABLE).addSet(USER_PASSWORD_FIELD + " = ?, " + USER_SALT_FIELD + " =? ")
			.addWhere(USER_ID_FIELD + " = ?").getQuery();
	...
	public static final String GET_TARIFF_BY_ID = new QueryStringBuilder()
			.addSelect(TARIFF_ID_FIELD + ", " + TARIFF_NAME_FIELD + ", " + TARIFF_DESCRIPTION_FIELD + ", "
					+ TARIFF_PRICE_FIELD + ", " + TARIFF_SERVICE_ID_FIELD)
	...
	public static final String ADD_TARIFF = new QueryStringBuilder().addInsert(TARIFF_TABLE, TARIFF_NAME_FIELD + ", "
			+ TARIFF_DESCRIPTION_FIELD + ", " + TARIFF_PRICE_FIELD + ", " + TARIFF_SERVICE_ID_FIELD)
			.addValues("?, ?, ?, ?").getQuery();
	...
	public static final String GET_USERS_TRANSACTION = new QueryStringBuilder()
			.addSelect(TRANSACTION_ID_FIELD + ", " + TRANSACTION_USER_ID_FIELD + ", " + TRANSACTION_TIMESTAMP_FIELD
					+ ", " + TRANSACTION_AMOUNT_FIELD + ", " + TRANSACTION_DESCRIPTION_FIELD)
			.addFrom(TRANSACTION_TABLE).addWhere(TRANSACTION_USER_ID_FIELD + " = ? ORDER BY " + TRANSACTION_TIMESTAMP_FIELD + " DESC ").addLimit().getQuery();
	public static final String GET_TRANSACTION_NUMBER_OF_USER = new QueryStringBuilder().addSelect("")
			.addCount("*").addFrom(TRANSACTION_TABLE).addWhere(TRANSACTION_USER_ID_FIELD + "= ? ").getQuery();
	...
	public static final String ADD_SERVICE = new QueryStringBuilder().addInsert(SERVICE_TABLE,SERVICE_NAME_FIELD + ", " + SERVICE_DESCRIPTION_FIELD)
			.addValues("?,?").getQuery();
	...
	public static final String DELETE_SERVICE = new QueryStringBuilder().addDelete()
			.addFrom(SERVICE_TABLE).addWhere(SERVICE_ID_FIELD + "= ? ").getQuery();
	
	/** ROLE QUERIES */
	public static final String GET_ROLE_BY_ID = new QueryStringBuilder()
			.addSelect(ROLE_ID_FIELD + ", " + ROLE_NAME_FIELD + ", " + ROLE_DESCRIPTION_FIELD)
			.addFrom(ROLE_TABLE).addWhere(ROLE_ID_FIELD + " = ? ").getQuery();
	public static final String GET_ALL_ROLES = new QueryStringBuilder()
			.addSelect(ROLE_ID_FIELD + ", " + ROLE_NAME_FIELD + ", " + ROLE_DESCRIPTION_FIELD)
			.addFrom(ROLE_TABLE).getQuery();
	public static final String ADD_ROLE = new QueryStringBuilder()
			.addInsert(ROLE_TABLE, ROLE_NAME_FIELD + ", " + ROLE_DESCRIPTION_FIELD)
			.addValues("?, ?").getQuery();
	public static final String UPDATE_ROLE = new QueryStringBuilder()
			.addUpdate(ROLE_TABLE).addSet(ROLE_NAME_FIELD + " = ?, " + ROLE_DESCRIPTION_FIELD + " = ?")
			.addWhere(ROLE_ID_FIELD + " = ? ").getQuery();
	public static final String DELETE_ROLE = new QueryStringBuilder()
			.addDelete().addFrom(ROLE_TABLE).addWhere(ROLE_ID_FIELD + " = ? ").getQuery();
